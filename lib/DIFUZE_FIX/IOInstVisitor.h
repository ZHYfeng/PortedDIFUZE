#ifndef PROJECT_IOINSTVISITOR_H_FIX
#define PROJECT_IOINSTVISITOR_H_FIX
...
namespace IOCTL_CHECKER_FIX {
    ...
    public:
        nlohmann::json *result_json = nullptr;
        nlohmann::json *current_result_json = nullptr;
        ...
        IOInstVisitor(Function *targetFunc, std::set<int> &cmdArg, std::set<int> &uArg,
    ...
    private:
        ...
        void getArgPropogationInfo(CallInst *I, std::set<int> &cmdArg, std::set<int> &uArg,
...
#endif //PROJECT_IOINSTVISITOR_H_FIX
